...
int main()
{
    ...
    Если диапазон значений не большой, то выбирать следует из быстрой сортировки или сортировки
    подсчетом, в зависимости от критерия время/занимаемый объем памяти*/
